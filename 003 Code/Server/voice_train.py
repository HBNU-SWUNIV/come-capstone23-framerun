...
# 설정 변수 정의
DATA_TRAIN_PATH = "/Framerun/voice_run/data/train"
npy_PATH = "/Framerun/user/voice_npy/data.npy"
learning_rate = 0.005
...
class NeuralNetwork:
    ...
    def train(self):
        ...
        split_X = np.split(self.X_train, batch_size)
        split_Y = np.split(self.Y_train, batch_size)
        ...
        for epoch in range(self.training_epochs * self.tf_classes):
            ...
            if test_accuracy > best_acc:
                ...
                saver.save(sess, r"C:\Framerun\voice_run\checkpoint\best")
